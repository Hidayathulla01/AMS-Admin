    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="<?php echo $formAction;?>" method="POST" class="row g-3">
		<div class="col-md-6">
          ...
          <input type="text" class="form-control" id="course_name" name="course_name" value="<?php echo $response1['course_name']; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="student_name" class="form-label">Student Full Name :</label>
          <input type="text" class="form-control" id="student_name" name="student_name" value="<?php echo $response->user_name; ?>" readonly>
        </div>
        <div class="col-md-6">
          <label for="dob" class="form-label">Date Of Birth:</label>
          <input type="date" class="form-control" id="dob" name="dob" value="<?php echo $response->dob; ?>" readonly>
        ...
        <div class="col-md-6">
          ...
          <input type="email" class="form-control" id="email" name="email" value="<?php echo $response->email; ?>"readonly>
        </div>
		<div class="col-md-6">
          <label for="password" class="form-label">Password :</label>
          <input type="text" class="form-control" id="password" name="password" value="<?php echo $response->password; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="mobile_no" class="form-label">Mobile number :</label>
          <input type="tel" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $response->mobile_no; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="country" class="form-label">Country :</label>
          <input type="text" class="form-control" id="country" name="country" value="<?php echo $response->country; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="parent_name" class="form-label">Parent Name:</label>
          <input type="text" class="form-control" id="parent_name" name="parent_name" value="<?php echo $response->parent_name; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="relation" class="form-label">RealtionShip:</label>
          <input type="text" class="form-control" id="relation" name="relation" value="<?php echo $response->relation; ?>"readonly>
        </div>
        <div class="col-md-6">
          <label for="parent_mobile" class="form-label">Parent's Mobile number :</label>
          <input type="tel" class="form-control" id="parent_mobile" name="parent_mobile" value="<?php echo $response->parent_mobile; ?>"readonly>
        </div>
		<div class="col-md-6">
          <label for="payment_method" class="form-label">Payment Method</label>
          <input type="text" class="form-control" id="payment_method" name="payment_method" value="<?php echo $response->payment_method; ?>"readonly>
        </div>
      </form>
    </main>
  </div>
