  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">List of Masjid</h1>
        <a href="<?php echo base_url("Masjid_Controller/add");?>" class="btn-sm btn btn-primary"> <i class="fa fa-plus" aria-hidden="true"></i></a>
      </div>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="row g-3">
              <div class="col-md-6">
                <label for="inputZip" class="form-label">Contact person : 1 2 3 4 5</label>
              </div>
              <div class="col-md-6">
                <label for="inputZip" class="form-label">Mobile number : 1 2 3 </label>
              </div>
            </form>
          </div>
        </div>
 ...
 <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  ...
  <script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
	...
	table = $('#example').DataTable({
		...
		"ajax": "<?php echo base_url('Masjid_Controller/GetList')?>", 
		language: {
			paginate: {
    ...
    if (confirmDelete) {
		...
		function edit_list(masjid_id){
			alert(masjid_id);		 
		  $("#edit").load("<?php echo base_url("Masjid_Controller/view_masjid_details")?>/"+ masjid_id, function () {
                $("#edit").modal("show");
            });
        }
