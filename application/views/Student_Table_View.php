  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="<?php echo base_url("Student_Controller/addStudent");?>" class="btn-sm btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></a>
      </div>
      <div  class="col-md-12">
        <div>
            <form action="<?php echo base_url('Student_Controller/import_csv'); ?>" method="post" enctype="multipart/form-data">
    			<input type="file" name="csv_file" accept=".csv" required>
    			<button type="submit" class="btn-sm btn btn-primary">Import CSV File</button>
    		</form>
        </div>
 ...
 <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  ...
  <script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
	...
	table = $('#example').DataTable({
		...
		"ajax": "<?php echo base_url('GetStudentsList')?>", 
		language: {
			paginate: {
