...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	  ...
	  <?php //pr($response);
			$filename = basename($response->profile_picture);
	  ?>
    
    <form action="<?php echo $formAction;?>" method="POST" enctype="multipart/form-data" class="row g-3">		
        <div class="col-md-6">
          <label for="user_name" class="form-label">Teacher Full Name :</label>
          <input type="text" class="form-control" id="user_name" name="user_name" value="<?php echo $response->user_name; ?>" required>
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="title" name="title" value="<?php echo $response->title; ?>">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-3">
          ...
          <input type="date" class="form-control" id="dob" name="dob" placeholder=" Select Date of Birth" value="<?php echo $response->dob; ?>">
          <div class="invalid-feedback">
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" id="profile_picture_path" value="<?php echo $filename; ?>" disabled>
        </div>
        <div class="col-md-6">
		...
		<div class="col-md-6">
          ...
          <input type="text" class="form-control" id="password" name="password" value="<?php echo $response->password; ?>" required>
        </div>
		<div class="col-md-6">
          <label for="pin" class="form-label">Pin</label>
          <input type="text" class="form-control" id="pin" name="pin" value="<?php echo $response->pin; ?>">
        </div>
        <div class="col-md-6">
          <label for="mobile_no" class="form-label">Mobile number :</label>
          <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $response->mobile_no; ?>" oninput="this.value = this.value.replace(/[^0-9+]/g, '')" maxlength="15">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <input type="date" class="form-control" id="date_of_join" name="date_of_join" value="<?php echo $response->date_of_join; ?>">
        </div>
        <div class="col-md-6">
          <label for="date_of_resigning" class="form-label">Date Of Resign:</label>
          <input type="date" class="form-control" id="date_of_resigning" name="date_of_resigning" value="<?php echo $response->date_of_resigning; ?>">
        </div>
