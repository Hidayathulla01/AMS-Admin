            ...
            <div class="col-lg-5 col-12 d-flex flex-column justify-content-center align-items-center bg-light ">
                <div class="container py-5">
                    <div class="form-container">
                        ...
                        <h4 class="text-center mb-4" style="color:#065392;">Attendance Management System</h4>
                        <form method="post" action="<?php echo base_url("AdminLogin/login");?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="password" id="password" value="<?= set_value('email', isset($email) ? $email : '') ?>" placeholder="Password" required>
                                <div class="invalid-feedback">Password is required.</div>
                            </div>
                            <div class="mb-3 text-start">
                                <input type="checkbox" id="remember" class="form-check-input">
                                <label for="remember" class="form-check-label">Remember Me</label>
                               <!--  <a href="#" class="float-end forgot-password">Forget Password?</a> -->
                            </div>
                            <div class="d-grid mb-3">
								<button class="btn btn-custom" type="submit">Sign in</button>
                            </div>
							<a href="<?php echo base_url("ForgetPwdIndex");?>" class="float-start forgot-password">Forget Password?</a>
                        </form>
                    </div>
                </div>
            </div>
