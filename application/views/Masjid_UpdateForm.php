    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="<?php echo $formAction;?>" method="POST" class="row g-3">
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="masjid_name" id="masjid_name" value="<?php echo $response->masjid_name; ?>" required>
        </div>
		<div class="col-md-6">
          <label for="pincode" class="form-label"><b>Pincode</b></label>
          <input type="text" class="form-control" name="pincode" id="pincode" value="<?php echo $response->pincode; ?>">
        </div>
        <div class="col-md-6">
          <label for="description" class="form-label"><b>Description</b></label>
          <textarea type="description" rows="3" name="description" class="form-control" id="description"><?php echo isset($response->description) ? htmlspecialchars($response->description) : ''; ?></textarea>
        </div>
		<div class="col-md-6">
          <label for="area" class="form-label"><b>Area</b></label>
          <textarea type="area" rows="3" class="form-control" name="area" id="area"><?php echo isset($response->area) ? htmlspecialchars($response->area) : ''; ?></textarea>
        </div>
        
        <div class="col-md-6">
          <label for="country" class="form-label"><b>Country</b></label>
          <input type="text" class="form-control" name="country" id="country" value="<?php echo $response->country; ?>">
        </div>
        <div class="col-md-6">
          <label for="contact_person" class="form-label"><b>Contact person</b></label>
          <input type="text" class="form-control" name="contact_person" id="contact_person" value="<?php echo $response->contact_person; ?>">
        </div>
        <div class="col-md-6">
          <label for="mobile_no" class="form-label"><b>Mobile number</b></label>
          <input type="text" class="form-control" name="mobile_no" id="mobile_no" value="<?php echo $response->mobile_no; ?>" oninput="this.value = this.value.replace(/[^0-9+]/g, '')">
        </div>
        <div class="col-md-6">
          <label for="location" class="form-label"><b>Location</b></label>
          <textarea type="text"  rows="3" class="form-control" name="location" id="location"><?php echo isset($response->location) ? htmlspecialchars($response->location) : ''; ?></textarea>
        </div>
