 ...
 <section class="home-section">
	<nav>
		<div class="sidebar-button">
			...
			<span class="dashboard" style="color: #223A68; " ><b>List of Beneficiaries</b></span>
		</div>
		<div class="col-sm-8">
			<a class="pull-right btn btn-success btn-xs" href="<?php echo site_url() ?>Export"><i class="fa fa-file-excel-o"></i>Export Data</a>
		</div>
	 </section><br>
...
<script type="text/javascript">
	...
	table = $('#example').DataTable({
		"processing": true,
		"ajax": "<?php echo base_url('GetReport')?>", 
		language: {
			paginate: {
