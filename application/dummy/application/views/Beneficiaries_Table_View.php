 ...
 <section class="home-section">
	<nav>
		<div class="sidebar-button">
			...
			<span class="dashboard" style="color: #223A68; " ><b>Beneficiary Management</b></span>
		</div>
		<div class="search-box">
			<button class="btn btn-sm btn-primary" id="addUserBtn" style="color:white; <?php if (strpos($GetId, 'Add') === false) { ?>display:none<?php } ?>" >Add Beneficiary</button>
		</div>
	 </section><br>
<div class="form">
	<div>
...
<script type="text/javascript">
	...
	table = $('#example').DataTable({
		"processing": true,
		"ajax": "<?php echo base_url('GetDataList')?>", 
		language: {
			paginate: {
 ...
 // for insert
    $(document).ready(function () {
        $("#addUserBtn").click(function () {
            $("#myModal").load("<?php echo base_url("Beneficiary_Controller/create");?>", function () {
                $("#myModal").modal("show");
            });
        });
    });
...
////////for update////////
		function edit_list(id){
		  ...
		  $("#edit").load("<?php echo base_url("Beneficiary_Controller/updatedata")?>/"+ id, function () {
                $("#edit").modal("show");
            });
        }
